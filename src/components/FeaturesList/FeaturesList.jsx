...
const FeaturesList = ({obj}) => { 
    ...
    <li><IconSvg width={20} height={20} iconName={"conditioner"}/><p>{`${obj.details.airConditioner} air conditioner`}</p></li>
    <li><IconSvg width={20} height={20} iconName={"CD"}/><p>{`${obj.details.CD} CD`}</p></li>
    <li><IconSvg width={20} height={20} iconName={"radio"}/><p>{`${obj.details.radio} radio`}</p></li>
    <li><IconSvg width={20} height={20} iconName={"hob"}/><p>{`${obj.details.radio} hob`}</p></li>
  </ul>
}
